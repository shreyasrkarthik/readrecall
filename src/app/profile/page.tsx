            ...
            <div>
              ...
              <div className="mt-4 space-y-4 border-t pt-4">
                <div className="flex flex-col sm:flex-row sm:items-center">
                  ...
                  <span className="mt-1 sm:mt-0 text-gray-800">{user?.email || 'Not provided'}</span>
                </div>
                <div className="flex flex-col sm:flex-row sm:items-center">
                  <span className="text-sm font-medium text-gray-500 sm:w-32">Member Since</span>
                  <span className="mt-1 sm:mt-0 text-gray-800">{new Date().toLocaleDateString('en-US', {year: 'numeric', month: 'long', day: 'numeric'})}</span>
                </div>
              </div>
            </div>
